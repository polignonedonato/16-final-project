...
#define N_PIXELS  15  // Number of pixels you are using
#define MIC_PIN    A1  // Microphone is attached to Trinket GPIO #2/Gemma D2 (A1)
#define LED_PIN    0  // NeoPixel LED strand is connected to GPIO #0 / D0
#define DC_OFFSET  0  // DC offset in mic signal - if unusure, leave 0
#define NOISE     1000  // Noise/hum/interference in mic signal
...
int
  ...
  minLvlAvg = 100,      // For dynamic adjustment of graph low & high
  maxLvlAvg = 800;
